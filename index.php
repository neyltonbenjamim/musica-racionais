                    ...
                    <div class="container">
                        ...
                        <div class="list">
                            <ul>
                                ...
                                <li><a title="<?= $musica['artista'].' - '.$musica['title'];?>" href="<?= $base.'?watch='.$musica['id'];?>" class="next-musica" id="<?= $musica['id'];?>" data-artista="<?= $musica['artista'];?>" data-title="<?= $musica['title'];?>" data-id="<?= $musica['id'];?>"><b><?= $musica['artista'];?></b> - <?= $musica['title'];?></a></li>
                                <?php endforeach;?>
                              </ul>
                        </div>                          
                    </div>
